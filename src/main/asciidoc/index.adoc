...
operation::table-samples[snippets='curl-request,path-parameters,request-parameters,http-response,links']
...
operation::table-paging[snippets='curl-request,path-parameters,http-response,links']
...
operation::table-extract[snippets='curl-request,path-parameters,http-response,links']
